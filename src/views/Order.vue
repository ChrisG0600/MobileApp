<template>
  <!-- SideNav -->
  <ion-menu :swipeGesture="false" content-id="main-content">
    ...
    <ion-header class="ion-no-border">
      <ion-toolbar>
          ...
          <div class="header-wrapper">
            <ion-title class="header">Our Foods</ion-title>
            <ion-icon class="header-cart" src="/assets/icons/cart.svg"></ion-icon>
          </div>
      </ion-toolbar>
    </ion-header>
    <ion-content class="ion-padding"> 
      <ion-searchbar class="search-bar" placeholder="try our new Beef Bibimbowl"></ion-searchbar>
      <div class="reward-button">
        <ion-button class="reward-all">All</ion-button>
        <ion-button>Beginner</ion-button>
        <ion-button>Intermediate</ion-button>
        <ion-button>Loyal</ion-button>
      </div>
        <ion-grid>
          <ion-row>
            <ion-col size="6">
              <ion-card @click="detailpage">
            ...
            <ion-col size="6">
              <ion-card>
                <ion-img src="/assets/images/broth-ramen.png"></ion-img>
                <ion-card-header>
                  <ion-card-title class="card-title">Kani Ramen</ion-card-title>
                  <ion-card-subtitle class="card-subtitle">Mix</ion-card-subtitle>
                </ion-card-header>
                <div class="price-wrapper">
            ...
            <ion-col size="6">
              <ion-card>
                <ion-img src="/assets/images/egg-ramen.png"></ion-img>
                <ion-card-header>
                  <ion-card-title class="card-title">Egg Ramen</ion-card-title>
                  <ion-card-subtitle class="card-subtitle">Egg</ion-card-subtitle>
                </ion-card-header>
                <div class="price-wrapper">
                  <p class="price">P 205</p>
                  <ion-icon class="rating" src="https://upload.wikimedia.org/wikipedia/commons/4/47/Rating_stars_4.5.svg"></ion-icon>
                </div>
              </ion-card>
            </ion-col>
            ...
            <ion-col size="6">
              <ion-card>
                <ion-img src="/assets/images/katsu-ramen.png"></ion-img>
                <ion-card-header>
                  <ion-card-title class="card-title">Katsu Ramen</ion-card-title>
                  <ion-card-subtitle class="card-subtitle">Meat</ion-card-subtitle>
                </ion-card-header>
                <div class="price-wrapper">
                  <p class="price">P 161</p>
                  <ion-icon class="rating" src="https://upload.wikimedia.org/wikipedia/commons/4/47/Rating_stars_4.5.svg"></ion-icon>
                </div>
              </ion-card>
            </ion-col>
            ...
            <ion-col size="6">
              <ion-card>
                <ion-img src="/assets/images/nori-ramen.png"></ion-img>
                <ion-card-header>
                  <ion-card-title class="card-title">Norie Ramen</ion-card-title>
                  <ion-card-subtitle class="card-subtitle">Meat</ion-card-subtitle>
                </ion-card-header>
                <div class="price-wrapper">
                  <p class="price">P 189</p>
                  <ion-icon class="rating" src="https://upload.wikimedia.org/wikipedia/commons/4/47/Rating_stars_4.5.svg"></ion-icon>
                </div>
              </ion-card>
            </ion-col>
...
<script>
  import {useIonRouter, IonCol,IonCardContent, IonGrid, IonRow,IonCard, IonCardHeader, IonCardSubtitle, IonCardTitle, IonButton, IonButtons, IonContent, IonHeader, IonMenu, IonMenuButton, IonMenuToggle, IonPage, IonTitle, IonToolbar, IonAvatar, IonImg, IonIcon } from '@ionic/vue';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const loyaltypage = () => {
        ionRouter.push('/loyalty-points', 'forward');
      }
      const detailpage = () => {
...
.count{
  ...
  font-size: 14px;
  background-color: rgb(213, 183, 30);
  color:white;
  border-radius: 50%;
  height: 20px;
  width: 20px;
